...
# =========================================================
# REAL GMAIL OTP EMAIL SENDER
# =========================================================

EMAIL_ADDRESS = "sumanth76720@gmail.com"

EMAIL_PASSWORD = "vvam jhyp yrqs vhqi"
...
def send_otp_email(receiver_email, otp):
    ...
    try:
        ...
        message["Subject"] = "Smart Crop Doctor AI OTP"
        ...
        message.set_content(
            f"""
Your Smart Crop Doctor AI OTP is:
...
if not st.session_state.authenticated:
    ...
    with register_tab:
        ...
        if st.button(
            ...
            elif entered_otp != st.session_state.get("otp"):
